...
rails g model group name:string description:text precedence:integer perm_add:bigint perm_remove:bigint perm:text
rails g model member user:references:index group:references:index
...
rails g model role name:string description:text precedence:integer
rails g model assignment user:references:index role:references:index
